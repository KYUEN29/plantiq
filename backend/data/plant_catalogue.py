...
PLANT_CATALOGUE = [
    ...
    plant("Echeveria", "Echeveria spp.", "succulent", "moderate", "A rosette-forming succulent group grown for sculptural foliage.", light="bright_direct", soils=("cactus_succulent_mix", "sandy_loam"), moisture="low", drought="high", overwatering="high", problems=("root_rot", "etiolation", "mealybugs")),
    plant("Haworthia", "Haworthiopsis attenuata", "succulent", "easy", "A compact rosette succulent often sold for windowsills and small containers.", aliases=("zebra haworthia",), light="bright_indirect", soils=("cactus_succulent_mix", "well_draining"), moisture="low", drought="high", overwatering="high", problems=("root_rot", "sunburn", "mealybugs")),
    ...
    plant("Tulsi / Holy Basil", "Ocimum tenuiflorum", "herb", "moderate", "An aromatic basil relative cultivated for culinary, cultural, and garden use.", aliases=("holy basil", "tulsi"), indoor=True, outdoor=True, light="full_sun", soils=("loamy", "well_draining"), moisture="moderate", problems=("aphids", "powdery_mildew", "leaf_spot")),
